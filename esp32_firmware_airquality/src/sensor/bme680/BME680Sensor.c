...
float send_bme680_sensor__temperature(BME680Reading reading){
    return reading.temperature;
}
float send_bme680_sensor__humidity(BME680Reading reading){
    return reading.humidity;
}
float send_bme680_sensor__pressure(BME680Reading reading){
